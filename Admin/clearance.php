...
<head>
  ...
  <title>Clearance | Baranggay Information System </title>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Clearance Records</h3>
              <br/>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Generate Clearance</h4>
          </div>
...
<script>
  $(function () {
    let table = $('.dataTable').DataTable({ 
        "ajax": {
            "url": "API/showAllClearanceRecord.php",
            "type": "post"
        }
    })
